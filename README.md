...
|--------------|----------|-----------|
| **MikroTik** | SSH, Telnet | RouterOS - shell mode support |
...
wget https://github.com/YOUR_REPO/backup-manager/releases/latest/download/BACKUP-MANAGER-v4.0-FINAL.tar.gz
